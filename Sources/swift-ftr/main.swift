...
struct SwiftFTRCommand: AsyncParsableCommand {
  static let configuration = CommandConfiguration(
    ...
    discussion: """
      ...
      """,
    subcommands: [Trace.self, Ping.self],
...
extension SwiftFTRCommand {
  struct Ping: AsyncParsableCommand {
    ...
    @Option(
      name: [.short, .customLong("interval")], help: "Interval between pings in seconds (default: 1.0)"
    )
    var interval: Double = 1.0

    @Option(name: [.short, .customLong("timeout")], help: "Timeout per ping in seconds (default: 2.0)")
